...
class Produto extends Action
{
    ...
    public function produtosListar()
    {
    ...
    */ 
    ...
    $ordenacao = "asc";
    $condicao = "WHERE id_categoria = ".Bootstrap::getIdByUrl();
    $produtos = $produto->select($campos, $ordenarPor, $ordenacao, $condicao);      
